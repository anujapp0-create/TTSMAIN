...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className={`group relative flex flex-col rounded-2xl border bg-white p-7 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg ${
        service.flagship
    ...
    >
      ...
      <span
        className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl group-hover:bg-brand-900 group-hover:text-gold-400 ${
